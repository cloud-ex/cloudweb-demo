  ...
  export default {
    ...
    watch: {
      ...
      bids(newList) {
        ...
        // 降序
        // console.log('bids####', newList);
        // for (let i = 0; i < newList.length-1; i++) {
        //   if (newList[i] < newList[i+1]) {
        //     console.log('bids出错了###', newList[i], newList[i+1]);
        //   }
        // }
      },
      asks(newList) {
        ...
        // console.log('asks####', newList);
        // for (let i = 0; i < newList.length-1; i++) {
        //   if (newList[i] > newList[i+1]) {
        //     console.log('asks出错了###', newList[i], newList[i+1]);
        //   }
        // }
      },
      coinUnit() {
    ...
    methods: {
      getAsk(bl) {
        ...
        // 降序
        // console.log('this.askOrder####', this.askOrder);
        for (let i = 0; i < this.askOrder.length - 1; i++) {
          if (this.askOrder[i] < this.askOrder[i+1]) {
            console.log('askOrder出错了####', this.askOrder[i], '###', this.askOrder[i+1]);
          }
        }
      },
      getBit(bl) {
        ...
        //降序
        // console.log('this.bidOrder#####', this.bidOrder);
        for (let i = 0; i < this.bidOrder.length - 1; i++) {
          if (this.bidOrder[i] < this.bidOrder[i+1]) {
            console.log('bidOrder出错了####', this.bidOrder[i], '###', this.bidOrder[i+1]);
          }
        }
      },
      // 对比价格和量的变化
      ...
      getShowData(list, way) {
        ...
        for (;index < len; index++) {
          ...
          obj.qty = Number(this.coinUnit ? obj.qty : this.changUnitGetVol(obj.qty, obj.px))

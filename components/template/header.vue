<template>
  <header class="pc-header">
    <div class="pc-header-web">
      ...
      <!-- <a
        class="exchange"
        @click="goUrl(token ? `${apiConfig.mainDomain}/usercenter/rebate?lang=${locale}` : 'https://support.lpmex.com/hc/zh-cn/articles/360032191251')"
      >{{ $t('header.invitation') }}</a> -->
      <nav class="pc-nav clearfix">
        <div class="jump-list">
          <!-- <a target="_blank" class="exchange" :href="`https://support.lpmex.com/hc/${locale}/sections/360001701593`" >{{$t('header.swapStudent')}}<span class="huo"></span></a> -->
          ...
          <!-- <a target="_blank" :href="`https://support.lpmex.com/hc/${locale}`">{{$t('header.HELP')}}</a> -->
          <!-- <a target="_blank" :href="`https://support.lpmex.com/hc/${locale}/categories/360000051514-%E5%85%AC%E5%91%8A%E4%B8%AD%E5%BF%83`">{{$t('header.ANNOUNCEMENT')}}</a> -->
    ...
    <div class="pc-header-m">
      <div class="pc-header-h5">
        ...
        >
          ...
          <!-- <li>
                       <a @click="goUrl(token ? `${apiConfig.mainDomain}/assets/rebate?lang=${locale}` : 'https://support.lpmex.com/hc/zh-cn/articles/360004879913')">{{ $t('header.invitation') }}</a>
                    </li> -->
          <!-- <li>
          ...
          <!-- <li>
                      <a target="_blank" :href="`https://support.lpmex.com/hc/${locale}/categories/360000051514`">{{$t('header.ANNOUNCEMENT')}}</a>
                    </li> -->
          <li v-if="token">
